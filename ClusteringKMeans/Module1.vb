Module Module1
    ...
    Sub Main(ByVal args() As String)
        Try
            ...
            Dim outlier() As Double = FindOutlier(rawData, clustering, numClusters, 0)
    ...
    Private Function InitClustering(ByVal numTuples As Integer, ByVal numClusters As Integer, ByVal randomSeed As Integer) As Integer()
    ...
    Private Function Allocate(ByVal numClusters As Integer, ByVal numAttributes As Integer) As Double()()
    ...
    Private Sub UpdateMeans(ByVal rawData()() As Double, ByVal clustering() As Integer, ByVal means()() As Double)
    ...
    Private Function ComputeCentroid(ByVal rawData()() As Double, ByVal clustering() As Integer, ByVal cluster As Integer, ByVal means()() As Double) As Double()
    ...
    Private Sub UpdateCentroids(ByVal rawData()() As Double, ByVal clustering() As Integer, ByVal means()() As Double, ByVal centroids()() As Double)
    ...
    Private Function Distance(ByVal tuple() As Double, ByVal vector() As Double) As Double
    ...
    Private Function MinIndex(ByVal distances() As Double) As Integer
    ...
    Private Function Assign(ByVal rawData()() As Double, ByVal clustering() As Integer, ByVal centroids()() As Double) As Boolean
    ...
    Private Function Cluster(ByVal rawData()() As Double, ByVal numClusters As Integer, ByVal numAttributes As Integer, ByVal maxCount As Integer) As Integer()
    ...
    Private Function FindOutlier(ByVal rawData()() As Double, ByVal clustering() As Integer, ByVal numClusters As Integer, ByVal cluster As Integer) As Double()
    ...
    Private Sub ShowMatrix(ByVal matrix()() As Double, ByVal numRows As Integer, ByVal newLine As Boolean)
    ...
    Private Sub ShowVector(ByVal vector() As Integer, ByVal newLine As Boolean)
    ...
    Private Sub ShowVector(ByVal vector() As Double, ByVal newLine As Boolean)
        For i As Integer = 0 To vector.Length - 1
    ...
    Private Sub ShowClustering(ByVal rawData()() As Double, ByVal numClusters As Integer, ByVal clustering() As Integer, ByVal newLine As Boolean)
        Console.WriteLine("-----------------")
